        ...
        <div className="title flex-container border--bottom ">
          ...
          <div className="add__form">
            <button
              ...
              style={{ padding: "3px 5px", borderRadius: "5px", backgroundColor: "#e75e8d", color: "#fff"}}
              onClick={handleOpenDialog}
            >
              <AddRoundedIcon style={{ marginBottom: "6px"}} className="icon-add" />
              ...
              <form className="form-add" onSubmit={handleSubmit(handleAddRoom)}>
                ...
                <DialogActions>
                  ...
                  <button
                    ...
                    style={{ backgroundColor: "#e75e8d", color: "#fff" }}
                    autoFocus
                  >
                    Add room
                  </button>
